...
class Imgproc(QtWidgets.QMainWindow):
	...
	def __init__(self):
		...
		self.recogbtn.clicked.connect(lambda:recognimage(self))
		self.browsebtn.clicked.connect(lambda:browseimage(self))
...
def recognimage_Test(x, filedir):
    allContoursWithData = []                # declare empty lists,
    validContoursWithData = []              # we will fill these shortly
